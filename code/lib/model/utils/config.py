...
__C.THREEDIM = edict()
__C.THREEDIM.CROP_LENGTH = 56
__C.THREEDIM.DET_THRESHOLD = 1 * 1e-12
__C.THREEDIM.IS_TRAIN = 1
__C.THREEDIM.ThreeDimRois = 4
...
program_name = os.path.split(current_path)[1]
setproctitle.setproctitle(program_name)
lib_path = os.path.abspath(current_path + '/..' + '/..' + '/..' + '/lib')
sys.path.append(lib_path)
# out_path = os.path.abspath(current_path +  '/..' +  '/..' + '/../output/' + program_name)
out_path = os.path.abspath('/data/zxn/output/' + program_name)

# out_path = os.path.abspath('/mnt/datasets/zxn/output/' + program_name)
if not os.path.exists(out_path):
    os.makedirs(out_path)
__C.TRAIN.out_path = out_path
